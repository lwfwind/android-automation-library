...
public class WindowManager {
     ...
     * @see #addWindow(View, String) #addWindow(View, String)#addWindow(View, String)#addWindow(View, String)#addWindow(View, String)#addWindow(View, String)
     * @see #removeWindow(Activity) #removeWindow(Activity)#removeWindow(Activity)#removeWindow(Activity)#removeWindow(Activity)#removeWindow(Activity)
     */
     ...
     * @see #addWindow(Activity) #addWindow(Activity)#addWindow(Activity)#addWindow(Activity)#addWindow(Activity)#addWindow(Activity)
     * @see #removeWindow(View) #removeWindow(View)#removeWindow(View)#removeWindow(View)#removeWindow(View)#removeWindow(View)
     */
