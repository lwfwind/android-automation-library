...
public class ViewFetcher {
    ...
    public View getRecyclerView(boolean shouldSleep, int recyclerViewIndex) {
        ...
        ArrayList<View> views = ViewUtils.filterViewsToSet(new Class[]{ViewGroup.class}, getAllViews(false));
    ...
    public List<View> getAllRecyclerViews(boolean shouldSleep) {
        ...
        @SuppressWarnings("unchecked")
        ArrayList<View> views = ViewUtils.filterViewsToSet(new Class[]{ViewGroup.class}, getAllViews(true));
        views = ViewUtils.removeInvisibleViews(views);
    ...
    public View[] getWindowDecorViews() {
        ...
        try {
            ...
            View[] result;
            ArrayList<View> viewList = (ArrayList<View>) viewsField.get(instance);
